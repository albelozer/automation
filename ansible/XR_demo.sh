...
echo
options=("Retrieve current XR telemetry configurtion" "Remove XR telemetry configuration" "Configure example Sensor-Group" "Configure example Destination-Group" "Configure exam ple Subscription" "Apply MDT template for Dial-out, TCP and GPBkv" "Apply MDT template for Dial-out, gRPC without TLS and GPBkv" "Apply MDT template for Dial-in, gRPC without T LS and GPBkv" "Add and remove Dial-In from Pipeline"  "Exit")
